...
{
    public partial class GalaksininKorKoltukSecimi : Form
    {
        public GalaksininKorKoltukSecimi()
        {
            InitializeComponent();
        }
        ...
        private void GalaksininKorKoltukSecimi_Load(object sender, EventArgs e)
        {
            textBox1.Text = a;
            textBox2.Text = b;
            textBox6.Text = "GALAKSİNİN";
            ...
            var koltuklar = context.musteriler.Where(k => k.Koltuk == "A4" && k.Film == "GALAKSİNİN").ToList(); // Koltuk numarası 5 olan satırları seçiniz
            ...
            var koltukl = context.musteriler.Where(k => k.Koltuk == "A1" && k.Film == "GALAKSİNİN").ToList(); // Koltuk numarası 5 olan satırları seçiniz
            ...
            var koltu = context.musteriler.Where(k => k.Koltuk == "A2" && k.Film == "GALAKSİNİN").ToList(); // Koltuk numarası 5 olan satırları seçiniz
            ...
            var kolt = context.musteriler.Where(k => k.Koltuk == "A3" && k.Film == "GALAKSİNİN").ToList(); // Koltuk numarası 5 olan satırları seçiniz
            ...
            var kol = context.musteriler.Where(k => k.Koltuk == "A5" && k.Film == "GALAKSİNİN").ToList(); // Koltuk numarası 5 olan satırları seçiniz
            ...
            var kltt = context.musteriler.Where(k => k.Koltuk == "B1" && k.Film == "GALAKSİNİN").ToList(); // Koltuk numarası 5 olan satırları seçiniz
            ...
            var klt = context.musteriler.Where(k => k.Koltuk == "B2" && k.Film == "GALAKSİNİN").ToList(); // Koltuk numarası 5 olan satırları seçiniz
            ...
            var kltklr = context.musteriler.Where(k => k.Koltuk == "B3" && k.Film == "GALAKSİNİN").ToList(); // Koltuk numarası 5 olan satırları seçiniz
            ...
            var kltklrr = context.musteriler.Where(k => k.Koltuk == "B4" && k.Film == "GALAKSİNİN").ToList(); // Koltuk numarası 5 olan satırları seçiniz
            ...
            var kltklrrr = context.musteriler.Where(k => k.Koltuk == "B5" && k.Film == "GALAKSİNİN").ToList(); // Koltuk numarası 5 olan satırları seçiniz
